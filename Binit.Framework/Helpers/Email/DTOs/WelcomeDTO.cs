...
using Lang = Binit.Framework.Localization.LocalizationConstants.BinitFramework.Helpers.Email.Views.Welcome;

namespace Binit.Framework.Helpers.Email.DTOs
{
    public class WelcomeDTO : IEmailDTO
    {
        public WelcomeDTO(IConfiguration configuration, IStringLocalizer<SharedResources> localizer)
        {
        ...
        public TemplateConstants.TemplateEnum Template
        {
            get
            {
                return TemplateConstants.TemplateEnum.Welcome;
            }
        }
