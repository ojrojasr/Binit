...
using Lang = Binit.Framework.Localization.LocalizationConstants.DomainLogic.Services.BackOfficeUserService;

namespace Domain.Logic.Services
{
    /// <summary>
    /// Service for backoffice user administration.
    /// </summary>
    public class BackOfficeUserService : Service<BackOfficeUser>, IBackOfficeUserService
    {
        #region Properties
        ...
        public BackOfficeUserService(IExceptionManager exceptionManager, ILogger logger, IOperationContext operationContext,
        ...
        /// </summary>
        public async Task<string> CreateAsync(BackOfficeUser user, IEnumerable<string> roles)
        {
        ...
        /// Check the IdentityException.Errors property for more details.
        /// </summary>
        public async Task UpdateAsync(BackOfficeUser user, IEnumerable<string> roles)
        {
            ...
            logger.LogTrace("Updated backoffice user.");
        }

        ///<summary>
        /// Get user by Id including all its dependencies.
        ///</summary>
        public async Task<BackOfficeUser> GetFullAsync(Guid userId)
        {
