...
{
    [HtmlTargetElement("ignite-input", Attributes = "for-property", TagStructure = TagStructure.NormalOrSelfClosing)]
    public class IgniteInputTagHelper : TagHelper
    {
        ...
        public IgniteInputTagHelper(IHtmlGenerator generator)
        {
