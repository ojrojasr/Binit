...
namespace WebApp.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessage = Lang.CodeStringLength, MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", this.localizer[Lang.InvalidCode]);
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            StatusMessage = this.localizer[Lang.AuthenticatorVerified];
